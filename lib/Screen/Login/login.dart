...
class _LoginScreenState extends State<LoginScreen> {
  ...
  fetchAlbum() async {
    String id = phoneController.text;
    try{
      int nid = int.parse(id);
      userinfo.email = "";
      userinfo.phonenumber = id;
    }catch(e){
      userinfo.email = id;
      userinfo.phonenumber = "";
    }
    userinfo.domain = "TAXIDEALS";
                            ...
                            child: new Row(
                              ...
                              children: <Widget>[
                                ...
                                new InkWell(
                                  onTap: () =>
                                      {
                                        Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (context) => new SignUpScreen()))
                                      },
                                  child: new Text(
                                    "Sign Up",
