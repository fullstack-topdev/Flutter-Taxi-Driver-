            ...
            Container(
                ...
                child: ButtonTheme(
                    ...
                    child: RaisedButton(
                      ...
                      elevation: 0.0,
                      color: primaryColor,
                      child: isEnabledOnline? Text('Online',style: headingWhite) : Text('Offline',style: heading18Black), 
                      onPressed: (){
                        setState(() {
                          isEnabledOnline = !isEnabledOnline;
                          showDialog(
                              context: context,
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  title: Center(child: Text('Ride Finished')),
                                  content: Stack(
                                    children: <Widget>[
                                      Form(
                                        key: _formKey,
                                            ...
                                            Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: <Widget>[
                                                    Expanded(
                                                      flex: 1,
                                                      child: Text('Source:', textAlign: TextAlign.left, style: textGrey),
                                                    ),
                                                    Expanded(
                                                      flex: 2,
                                                      child: Text('10, Keiv, Ukraina', textAlign: TextAlign.left, style: TextStyle(
                                            ...
                                            Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: <Widget>[
                                                    Expanded(
                                                      flex: 1,
                                                      child: Text('Destination:', textAlign: TextAlign.left, style: textGrey),
                                                    ),
                                                    Expanded(
                                                      flex: 2,
                                                      child: Text('100, Keiv, Ukraina', textAlign: TextAlign.left,),
                                                    )
                                                  ],
                                                )
                                            ),
                                              ...
                                              padding: EdgeInsets.only(top: 14.0),
                                                child: Row(
                                                  ...
                                                  children: <Widget>[
                                                    Expanded(
                                                      flex: 1,
                                                      child: Text('Total Km:', textAlign: TextAlign.left, style: textGrey),
                                                    ),
                                                    Expanded(
                                                      flex: 2,
                                            ...
                                            Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: <Widget>[
                                                    Expanded(
                                                      flex: 1,
                                                      child: Text('Total Price:', textAlign: TextAlign.left, style: textGrey),
                                                    ),
                                                    Expanded(
                                                      flex: 2,
                                                      child: Text('100', textAlign: TextAlign.left,),
                                                    ),
                                                  ],
                                                )
                                            ),
                                            ...
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                decoration: new InputDecoration(
                                                  labelText: "Please enter your valuable feedback",
                                            ...
                                            Padding(
                                              ...
                                              child: RaisedButton(
                                                ...
                                                onPressed: () {
                                                  ...
                                                  "rideId": "string",
                                                  "taxiDetailId": "string",
                                                  "updatedOn": "2020-12-11T00:20:46.600Z",
                                                  "userFullName": "string",
                                                  "userId": "string"
                                                };
                                                ApiHelper.postRequest(Constants.BASE_URL + Constants.BASE_URL_ACCEPT, data);
