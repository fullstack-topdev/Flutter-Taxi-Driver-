...
import 'package:flutter_taxi_user/data/Model/get_routes_request_model.dart';
...
import 'package:flutter_taxi_user/Components/loading.dart';
import 'imageSteps.dart';

class PickUp extends StatefulWidget {
  final String id;
  PickUp({Key key, @required this.id}) : super(key: key);

  @override
  _PickUpState createState() => _PickUpState(id);
}
...
class _PickUpState extends State<PickUp> {
  ...
  final String id;
  _PickUpState(this.id);

  var fromLocations = [
    {"latitude": 39.155232, "longitude": -95.473636},
    {"latitude": 39.175232, "longitude": -95.474636},
    {"latitude": 39.155232, "longitude": -95.473636},
    {"latitude": 39.185232, "longitude": -95.472636},
    {"latitude": 39.145232, "longitude": -95.471636},
  ];

   var toLocations = [
    {"latitude": 39.115153, "longitude": -95.638949},
    {"latitude": 39.185232, "longitude": -95.634636},
    {"latitude": 39.155232, "longitude": -95.633636},
    {"latitude": 39.175232, "longitude": -95.632636},
    {"latitude": 39.145232, "longitude": -95.631636},
  ];

  LatLng currentLocation = LatLng(39.155232, -95.473636);
  LatLng fromLocation = LatLng(39.175232, -95.474636);
  LatLng toLocation = LatLng(39.185232, -95.634636);
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    var fLatitude = fromLocations[index]['latitude'];
    var fLongitude = fromLocations[index]['longitude'];
    var tLatitude = toLocations[index]['latitude'];
    var tLongitude = toLocations[index]['longitude'];
    fromLocation = LatLng(fLatitude, fLongitude);
    toLocation = LatLng(tLatitude, tLongitude);
    addMarker();
    getRouter();
