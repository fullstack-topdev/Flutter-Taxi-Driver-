...
class RequestDetail extends StatefulWidget {
 final String id;
//
 RequestDetail({Key key, @required this.id}) : super(key: key);

  @override
  _RequestDetailState createState() => _RequestDetailState(id);
}
        ...
        child: ButtonTheme(
          ...
          child: RaisedButton(
            ...
            onPressed: (){
              ...
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => PickUp(id: '$id')));
            },
          ),
        ),
      ),
